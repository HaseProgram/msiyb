...
public:
	...
	*/
	...
	\param[in] name The name of the mutex object.
	*/
	void Init(t_secattr mutexAttr, bool initialOwner, char* name) override;
	...
	\param[in] name The name of the mutex object.
	*/
	void Init(LPSECURITY_ATTRIBUTES mutexAttr, BOOL initialOwner, LPCTSTR name);
	...
	*/
	bool Lock(unsigned long timeout = INFINITE) override;
